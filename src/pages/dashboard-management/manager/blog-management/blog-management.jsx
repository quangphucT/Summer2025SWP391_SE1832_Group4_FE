...
export default function BlogManagement() {
  ...
  return (
    <div className="blog-mgmt-root">
      ...
      {tagLoading ? (
        <p style={{ margin: "8px 24px" }}>Loading...</p>
      ) : (
      ...
      {tagModalOpen && (
        <div className="blog-mgmt-modal-bg">
          <form className="blog-mgmt-modal" onSubmit={saveTag}>
            ...
            <tbody>
              {blogs.map(blog => (
                <tr key={blog.blogId}>
                  ...
                  <td>
                    {blog.blogImageUrl ? (
                      <img src={blog.blogImageUrl} alt="" style={{ width: 60, height: 40, objectFit: "cover", borderRadius: 6 }} />
                    ) : (
                      <span>No image</span>
                    )}
                  </td>
      ...
      {blogModalOpen && (
        <div className="blog-mgmt-modal-bg">
          <form className="blog-mgmt-modal" onSubmit={saveBlog}>
